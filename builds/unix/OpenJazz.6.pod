...
B<OpenJazz> [options] <I<game directory 1>> <I<game directory 2>>
...
=item B<-s, --scale[=]> <I<Factor>>

Scale window by factor

=item B<-w, --world[=]> <I<World>> B<-l, --level[=]> <I<Level>>
...
Integrating the ports (Wii, 3DS, PSP, ...)
Additional coding
Modernizing
UI improvements
