...
static void all(void) {
    ...
    while (!(map = hashmap_new_with_allocator(xmalloc, NULL, xfree, sizeof(int),
        0, seed, seed, hash_int, compare_ints_udata, NULL, NULL))) {}
    ...
    while (!(map = hashmap_new_with_allocator(xmalloc, NULL, xfree,
...
static void benchmarks(void) {
    ...
    map = hashmap_new_with_allocator(xmalloc, NULL, xfree, sizeof(int), 0, seed,
        seed, hash_int, compare_ints_udata, NULL, NULL);
    bench("set", N, {
    ...
    map = hashmap_new_with_allocator(xmalloc, NULL, xfree, sizeof(int), N, seed,
        seed, hash_int, compare_ints_udata, NULL, NULL);
    bench("set (cap)", N, {
        const int *v = hashmap_set(map, &vals[i]);
        assert(!v);
